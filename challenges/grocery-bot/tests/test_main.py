...
class PlannerTests(unittest.TestCase):
    ...
    def test_difficulty_resolution_profiles(self) -> None:
        ...
        self.assertFalse(expert.random_tie_break)
        self.assertEqual(expert.seed, 0)
